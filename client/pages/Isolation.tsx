      ...
      <main className="container mx-auto flex-1 py-12 px-4">
        ...
        <section className="py-12 md:py-20">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 leading-tight">
              Isolation thermique : réduisez vos factures et améliorez votre
              confort
            </h1>

            <h2 className="mt-6 text-xl text-slate-700 leading-relaxed">
              Jusqu'à 30 % d'économies d'énergie grâce à une isolation
              performante. Étude gratuite & vérification des aides disponibles.
            </h2>

            <p className="mt-4 text-sm text-slate-600">
              ✓ Étude gratuite • ✓ Sans engagement • ✓ Travaux réalisés par
        ...
        <section className="py-12 md:py-16 border-t">
          <h2 className="text-3xl font-bold text-slate-900 mb-10">
            Pourquoi améliorer l'isolation de votre logement ?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">
                ✓ Baisse durable de vos factures énergétiques
              </h3>
              <p className="text-slate-600 text-sm">
                Une bonne isolation réduit fortement la consommation
                énergétique.
              </p>
            </div>
            <div className="bg-slate-50 p-6 rounded-lg">
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">
                ✓ Accès à des aides financières importantes
              </h3>
              <p className="text-slate-600 text-sm">
        ...
        <section className="py-12 md:py-16 border-t">
          <h2 className="text-3xl font-bold text-slate-900 mb-10">
            Quelles solutions d'isolation existent ?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            <div className="bg-white border border-border rounded-lg p-6">
              ...
              <p className="text-slate-600 text-sm">
                La solution la plus rentable et la plus rapide à mettre en
                place.
              </p>
            </div>
            <div className="bg-white border border-border rounded-lg p-6">
          ...
          <p className="mt-8 text-slate-600 max-w-2xl">
            Un conseiller identifie la solution la plus adaptée à votre
            logement.
          </p>
        </section>
        ...
        <section className="py-12 md:py-16 border-t">
          <h2 className="text-3xl font-bold text-slate-900 mb-10">
            Comment se déroule votre projet d'isolation ?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl">
            ...
            <div className="bg-primary bg-opacity-10 border border-primary border-opacity-20 rounded-lg p-6 text-center">
              <p className="font-semibold text-white">
                Mise en relation professionnel
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 border-t">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Être rappelé pour une étude d'isolation gratuite
          </h2>
          <p className="text-lg text-slate-600 mb-8 max-w-2xl">
            Un conseiller vous contacte pour analyser votre logement et vous
            proposer la solution la plus efficace.
          </p>
              ...
              {!sent ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="mt-3 text-slate-700">
                    Votre demande a bien été envoyée. Un expert en isolation
                    vous contactera sous 48 heures ouvrables.
                  </p>
        ...
        <section className="py-12 md:py-16 border-t">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Des travaux réalisés par des professionnels certifiés
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            EcoNova Solutions travaille avec des partenaires spécialisés dans
            l'isolation thermique, sélectionnés pour leur expertise et leur
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
            ...
            <div className="border border-border rounded-lg p-4 text-center">
              <p className="font-semibold text-slate-900">
                Accompagnement aides & démarches
              </p>
            </div>
          </div>
